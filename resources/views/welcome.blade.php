...
<main class="container mt-3">
    ...
    <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
            <h2 class="display-5 mb-4 mb-md-5 text-center" style="color: #028773;">Latest Posts</h2>
                        ...
                        <div class="card border-0 bg-transparent">
                            ...
                            <div class="card-body m-0 p-0">
                                <div class="entry-header mb-3">
                                    <h2 class="card-title entry-title h4 m-0" style="color: #028773;">
                                        {{ $post->title }}
                                    </h2>
                                    ...
                                    <li class="px-1 py-1">
                                        <a class="fs-7 link-secondary text-decoration-none d-flex align-items-center" href="#!">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-calendar3 me-1" viewBox="0 0 16 16">
                                                ...
                                                <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
                                            </svg>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <a href="{{route('posts.index')}}" class="btn bsb-btn-2xl btn-primary rounded-pill mt-5 mt-xl-10" style="background-color: #028773; border-color: #028773;">All Posts</a>
                </div>
            </div>
        </div>
    </section>
